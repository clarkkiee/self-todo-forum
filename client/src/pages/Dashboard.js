...
function Dashboard() {
  ...
  const components = [
    <Dashboardcontent fullname={userData.fullname} />,
    <Communities />,
  ];
  ...
  return (
    <div className="bg-primary-dark min-h-screen">
      {error ? (
        ...
        <div className="flex flex-col justify-center p-4 bg-white-100 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10  ">
          <Navbar username={userData.username} fullname={userData.fullname} />
          <div className="flex gap-8 m-4">
            <div className="flex flex-col p-2 items-start gap-2 w-[15vw]">
              <button
                autoFocus={true}
